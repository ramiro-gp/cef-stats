...
export function GroupTicker({ messages }: { messages: string[] }) {
  ...
  return <div className="mt-3 flex min-h-11 items-center gap-3 overflow-hidden rounded-2xl border border-emerald-500/15 bg-emerald-500/[0.06] px-3.5 py-2.5">
    <span className="flex shrink-0 items-center gap-1.5 text-[10px] font-black uppercase tracking-[0.16em] text-emerald-500"><span className="h-1.5 w-1.5 rounded-full bg-emerald-500" /><span className="hidden sm:inline">{APP_WORDMARK.primary}</span></span>
