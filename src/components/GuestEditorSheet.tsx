...
export function GuestEditorSheet({ guest, team, onSave, onClose }: { guest?: MatchParticipant; team: MatchTeam; onSave: (values: { name: string; avatar?: string; team: MatchTeam }) => void | Promise<void>; onClose: () => void }) {
