...
export function SettingsSheet({ user, theme, onTheme, onSaveUser, onClose, onStartTour, onOpenGuide }: Props) {
  ...
  return <ModalSheet title="Ajustes" onClose={onClose}>
    ...
    <p className="mt-6 text-center text-xs text-slate-400">{APP_NAME} {appVersion}<span className="mx-1.5">·</span>Desarrollado por <a href="https://ramirogp.me" target="_blank" rel="noopener noreferrer" className="font-bold text-emerald-600 underline-offset-2 hover:underline dark:text-emerald-400">Ramita G</a></p>
  </ModalSheet>
}
